...
public class ThreadUtils {
    ...
    public ThreadUtils(int corePoolSize) {
    ...
    private void initThreadPoolExecutor() {
        if(threadPools==null) {
            threadPools = new ThreadUtils(mMaximumPoolSize);
        }
    ...
    public static ThreadUtils threadPools;
    public static ThreadUtils setNormalThreadPoolProxy(int size) {
        return threadPools = new ThreadUtils(size);
    }
    static {
        threadPools = new ThreadUtils(5);
    }
}
