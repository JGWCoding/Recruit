...
public class ThreadPoolUtils {
    ...
    private void initThreadPoolExecutor() {
        if(threadPools==null) {
            threadPools = new ThreadPoolUtils(mMaximumPoolSize);
        }
    ...
    public static ThreadPoolUtils threadPools;
    public static ThreadPoolUtils getThreadPools(int size) {
        return threadPools = new ThreadPoolUtils(size);
    }
    static {
        threadPools = new ThreadPoolUtils(5);
    }
}
